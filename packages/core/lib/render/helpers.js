...
import { removeInternalKeys } from "../helpers.js";
 ...
 */
export const extendTemplateData = async function (config, data, filePath) {
 ...
 */
export const getDataForRenderFunction = function (app, data) {
 ...
 */
export const getFallbackData = function (variations, rootData) {
  for (let i = 0; i < variations.length; i += 1) {
    const variationData = removeInternalKeys(variations[i]);
...
export const getThemeMode = function (app, cookies = {}) {
  return cookies[`miyagi_${app.get("config").projectName}_theme`];
};

export const getComponentTextDirection = function (app, cookies = {}) {
