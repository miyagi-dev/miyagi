...
module.exports = {
	 ...
	 */
	getDataPathFromTemplatePath: function (filePath, fileType) {
	 ...
	 */
	getSchemaPathFromTemplatePath: function (filePath) {
		return filePath.replace(
			path.basename(filePath),
	 ...
	 */
	getTemplateFilePathFromDirectoryPath: function (directoryPath) {
		return path.join(
			directoryPath,
			`${module.exports.getResolvedFileName(
				global.config.files.templates.name,
